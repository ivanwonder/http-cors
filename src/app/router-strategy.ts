  ...
  shouldReuseRoute(future: ActivatedRouteSnapshot, current: ActivatedRouteSnapshot): boolean {
    ...
    if ( future.routeConfig ) {
      if (future.routeConfig.data ) {
        ...
        // if the use defined the reuse strategy, ignore the defaultReuse. prevent the same component with different url to reuse.
        if (Object.prototype.hasOwnProperty.call(future.routeConfig.data, 'reuse')) {
          return reUseUrl;
        }
      }
    }
